...
const columns = [
    {key:'Income', label: 'INGRESOS', classname: 'w-[5ch]', sortable: true},
    {key:'Cost', label: 'COSTOS', classname: 'w-[5ch]', sortable: true},
    {key:'Sales', label: 'VENTAS', classname: 'w-[5ch]', sortable: true},
    {key:'Year', label: 'AÑO', classname: 'w-[5ch]', sortable: true},
]
const ProfitsYear = () => {
    ...
    let profits = useAsyncList({
        async load({signal}) {
            let res = await fetch('http://localhost:4000/api/stats/year', {
                signal,
            })
